...
| M7 Rete e timeline | **in corso** (cattura, pcapng, HTTP, decodificatori, HAR sul guest BusyBox, ADR 0016; ispettore di rete e timeline input→effetti nell'app web sul guest Linux, ADR 0023; introspezione del guest dall'esterno — profilo del kernel da BTF e kallsyms, processi/mappe/file, syscall e punti d'arresto invisibili, base di M7/M8/M9, ADR 0027; mancano hook TLS e Android) | 10 app con HTTPS in chiaro e legato all'azione, HAR riapribile |
