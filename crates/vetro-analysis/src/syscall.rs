...
pub const TABLE: &[(u64, &str, &[Arg])] = &[
    ...
    (69, "preadv", &[Int, Ptr, Int, Int]),
    (70, "pwritev", &[Int, Ptr, Int, Int]),
    ...
    (139, "rt_sigreturn", &[]),
    (143, "setregid", &[Int, Int]),
    (144, "setgid", &[Int]),
    (145, "setreuid", &[Int, Int]),
    (146, "setuid", &[Int]),
    (147, "setresuid", &[Int, Int, Int]),
    (148, "getresuid", &[Ptr, Ptr, Ptr]),
    (149, "setresgid", &[Int, Int, Int]),
    (150, "getresgid", &[Ptr, Ptr, Ptr]),
    (153, "times", &[Ptr]),
    (158, "getgroups", &[Int, Ptr]),
    (159, "setgroups", &[Int, Ptr]),
    (154, "setpgid", &[Int, Int]),
    (155, "getpgid", &[Int]),
    (156, "getsid", &[Int]),
    (157, "setsid", &[]),
    ...
    (178, "gettid", &[]),
    (179, "sysinfo", &[Ptr]),
    (198, "socket", &[Int, Int, Int]),
    (199, "socketpair", &[Int, Int, Int, Ptr]),
    (200, "bind", &[Int, Ptr, Int]),
    (201, "listen", &[Int, Int]),
    (202, "accept", &[Int, Ptr, Ptr]),
    (203, "connect", &[Int, Ptr, Int]),
    (204, "getsockname", &[Int, Ptr, Ptr]),
    (205, "getpeername", &[Int, Ptr, Ptr]),
    (206, "sendto", &[Int, Ptr, Int, Hex, Ptr, Int]),
    (207, "recvfrom", &[Int, Ptr, Int, Hex, Ptr, Ptr]),
    (208, "setsockopt", &[Int, Int, Int, Ptr, Int]),
    (209, "getsockopt", &[Int, Int, Int, Ptr, Ptr]),
    (210, "shutdown", &[Int, Int]),
    (211, "sendmsg", &[Int, Ptr, Hex]),
    (212, "recvmsg", &[Int, Ptr, Hex]),
    (214, "brk", &[Ptr]),
    (215, "munmap", &[Ptr, Int]),
    ...
    (242, "accept4", &[Int, Ptr, Ptr, Hex]),
    (260, "wait4", &[Int, Ptr, Hex, Ptr]),
    (261, "prlimit64", &[Int, Int, Ptr, Ptr]),
    (278, "getrandom", &[Ptr, Int, Hex]),
    (286, "preadv2", &[Int, Ptr, Int, Int, Int, Hex]),
    (287, "pwritev2", &[Int, Ptr, Int, Int, Int, Hex]),
